...
df_men_perf = pd.read_csv('Data\Scraped_tables\Men_performances.csv')
new_records = []
...
df_men_perf.to_csv('Data\Preprocessed_tables\Men_performances.csv')

df_women_perf = pd.read_csv('Data\Scraped_tables\Women_performances.csv')
new_records = []
...
df_women_perf.to_csv('Data\Preprocessed_tables\Women_performances.csv')

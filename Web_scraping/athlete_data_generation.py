...
women_df.to_csv('Data/Scraped_tables/Women_Athletes.csv', index=False)

men_table = get_table("men",events,5)
men_df = pd.DataFrame(men_table,columns = ["Name", "Date of Birth", "Nationality", "Link"])
men_df.to_csv('Data/Scraped_tables/Men_Athletes.csv', index=False)